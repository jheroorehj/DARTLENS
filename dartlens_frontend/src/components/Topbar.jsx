      ...
      <div className="mx-auto max-w-[1400px] h-20 px-4 flex items-center justify-between">
        <div className="flex items-center gap-3 ml-4">
          <Link to="/" aria-label="Go home">
            ...
            src="/DL_logo.png" 
            alt="DART : Lens" 
            className="h-12 w-auto transition-transform duration-150 hover:scale-105 active:scale-100 hover:brightness-110 cursor-pointer" />
          </Link>
        </div>
        ...
        <nav className="flex items-center gap-3 mr-4">
          {isLoggedIn && (
            ...
            >
              ...
              alt="Wishlist" 
              className="h-9 w-auto transition-transform duration-150 hover:scale-105 active:scale-100 hover:brightness-110" />
            </button>
          )}
